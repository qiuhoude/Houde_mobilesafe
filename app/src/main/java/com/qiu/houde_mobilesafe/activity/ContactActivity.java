...
public class ContactActivity extends Activity {
    ...
    @Bind(R.id.lv_contects_list)
    ListView lvContectsList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvContectsList.setAdapter(new SimpleAdapter(this, readContact,
                R.layout.contact_list_item, new String[]{"name", "phone"},
                new int[]{R.id.tv_name, R.id.tv_phone}));

        lvContectsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
